                        ...
                        <div class="sidebarmenu">
                            <a class="menuitem submenuheader " href="" headerindex="0h">
                                ...
                                <span class="accordsuffix">
                                    <img src="<c:url value="/images/plus.gif"/>" class="statusicon">
                                </span>
                            </a>
                            <a class="menuitem submenuheader " href="" headerindex="1h">
                                ...
                                理财管理
                                <span class="accordsuffix">
                                    <img src="<c:url value="/images/minus.gif"/>" class="statusicon">
                                </span>
                            </a>
                            <div class="submenu" contentindex="1c" style="display: block;">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<c:url value="/view/transactionDetails.jsp"/>">
                                            购买记录
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<c:url value="/view/borrowDetails.jsp"/>">
                                            投资记录
                                        </a>
                                    </li>
                                </ul>
