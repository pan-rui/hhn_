...
/**
 * LoanPerson generated by hbm2java
 */
@Alias("loan_person")
public class LoanPerson implements java.io.Serializable {
...
//	@KeyInTable(value = IAccountUserDao.class,message = "无此用户...")
	...
	public LoanPerson(Integer loan_person_id){
		this.loan_person_id=loan_person_id;
	}

/*	public LoanPerson(Integer loan_person_id, Integer user_id, Integer loan_id, Byte education, String graduate_school, Integer graduate_year, Byte residence_type, String family_phone, Byte marriaged, Byte has_children, Byte has_house, Byte has_house_loan, Byte has_car, Byte has_car_loan, Integer household_address_id, Integer family_address_id, Integer residence_address_id, Date create_time, Date update_time) {
		this.loan_person_id = loan_person_id;
