...
//    }
    ...
    public String toString() {
        return "AccountUserDo{" + "id=" + id + ", usrCustId=" + usrCustId + ", username='" + username + '\''
                + ", email='" + email + '\'' + ", password='" + password + '\'' + ", dealpwd='" + dealpwd + '\''
                + ", mobilePhone='" + mobilePhone + '\'' + ", refferee='" + refferee + '\'' + ", rating=" + rating
                + ", creditrating=" + creditrating + ", lastIP='" + lastIP + '\'' + ", lastDate=" + lastDate
                + ", vipStatus=" + vipStatus + ", vipCreateTime=" + vipCreateTime + ", creditLimit=" + creditLimit
                + ", authStep=" + authStep + ", headImg='" + headImg + '\'' + ", enable=" + enable + ", cause='"
                + cause + '\'' + ", createTime=" + createTime + ", content='" + content + '\'' + ", usableSum="
                + usableSum + ", freezeSum=" + freezeSum + ", dueinSum=" + dueinSum + ", dueinCapitalSum="
                + dueinCapitalSum + ", dueinAccrualSum=" + dueinAccrualSum + ", dueoutSum=" + dueoutSum + ", kefuId="
                + kefuId + ", adminId=" + adminId + ", groupId=" + groupId + ", usableCreditLimit=" + usableCreditLimit
                + ", creditlimtor=" + creditlimtor + ", vipFee=" + vipFee + ", feeStatus=" + feeStatus
                + ", loginCount=" + loginCount + ", lockTime=" + lockTime + ", cashStatus=" + cashStatus + ", xmax="
                + xmax + ", x=" + x + ", xmin=" + xmin + ", isFirstVip=" + isFirstVip + ", source=" + source
                + ", registerIp='" + registerIp + '\'' + ", colorid=" + colorid + ", via='" + via + '\''
                + ", colorcheck='" + colorcheck + '\'' + ", colorTjr='" + colorTjr + '\'' + ", userGroup=" + userGroup
